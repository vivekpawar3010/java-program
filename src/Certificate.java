...
public class Certificate extends JFrame implements ActionListener {
    ...
    JLabel l1, l2, l3, l4, l5, l8, nameLabel;
        ...
        if (e.getSource() == btn1) {
            ...
            if (!s1.isEmpty() && !s2.isEmpty() && !s3.isEmpty() && !s4.isEmpty()) {
                try {
                    ...
                    String sql = "INSERT INTO MYCERTIFC (name, email, college, event, phone) VALUES (?, ?, ?, ?, ?)";
                    PreparedStatement preparedStatement = conn.prepareStatement(sql);
                    preparedStatement.setString(1, s1);
                    preparedStatement.setString(2, s2);
                    preparedStatement.setString(3, s3);
                    preparedStatement.setString(4, s4);
                    preparedStatement.setString(5, s8);
                ...
                JLabel certificateImageLabel = new JLabel();
                certificateImageLabel.setIcon(new ImageIcon("C:\\Users\\certificate.jpg")); // Change the path to your certificate image
